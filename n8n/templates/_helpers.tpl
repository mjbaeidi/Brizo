...
shared storage name
*/}}
{{- define "n8n-shared-storage.name" -}}
{{- printf "%s-shared-storage" (include "n8n.name" .) | trunc 63 | trimSuffix "-" -}}
{{- end }}
...
{{/*
n8n shared-storage persistence name
*/}}
{{- define "n8n-shared-storage.persistence.name" -}}
{{- printf "%s" (include "n8n-shared-storage.name" .) | trunc 63 | trimSuffix "-" -}}
{{- end }}

{{/*
n8n shared-storage persistence full name
*/}}
{{- define "n8n-shared-storage.persistence.fullname" -}}
{{- printf "%s-persistence" (include "n8n.main.fullname" .) | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/*
n8n shared-storage persistence labels
*/}}
{{- define "n8n-shared-storage.persistence.labels" -}}
helm.sh/chart: {{ include "n8n.chart" . }}
{{ include "n8n-shared-storage.persistence.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
...
{{/*
n8n shared-storage persistence selector labels
Selector fields are immutable after kubernetes resource creation. Do not edit this function.
*/}}
{{- define "n8n-shared-storage.persistence.selectorLabels" -}}
app.kubernetes.io/name: {{ include "n8n-shared-storage.persistence.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
app.kubernetes.io/component: persistence
{{- end }}
